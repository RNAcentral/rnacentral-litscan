...
class Facets extends React.Component {
  ...
  renameFacetValue(facet, facetValue){
    ...
    if (facet==='manually_annotated' && /^urs/.test(facetValue.label.toLowerCase()) && this.props.jobIds.find(id => id.toLowerCase() === facetValue.label.toLowerCase())) { facetValue.label = 'Manually annotated' }
