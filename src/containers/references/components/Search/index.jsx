        ...
        <div className="rna">
          <Row>
            <Col xs={12} sm={12} className="mb-3">
              <span style={titleStyle}>{titleText} { this.props.status !== "notSubmitted" && this.props.status !== "running" ? <small className="text-muted" style={small}>{this.props.hitCount} total <a className="text-muted" style={{verticalAlign: "10%"}} href="https://test.rnacentral.org/help/publications" target="_blank"> <MdHelpOutline /></a></small> : "" }</span>
            </Col>
          </Row>
          {
