...
let facetFields = 'title_value,abstract_value,body_value,journal,year,job_id';
let fields = 'job_id,title,abstract,body,author,doi,year,journal,pmid,pmcid,cited_by';
